    ...
    <div class="swiper-slide tours-slide">
      ...
      50
            ...
            <div class="d-flex align-items-center mt-1">
              ...
              <a class="text-decoration-none" style="color: red; font-weight: bold;">${valueToVND(tour.price)
      }</a>
            </div>
          </div>
          <!-- Tour information -->
  ...
  <nav aria-label="Pagination">
    <ul class="pagination">
      <li class="page-item ${page === 1 ? "disabled" : ""}">
        <a class="page-link" href="${`${tourType}.html?page=${page - 1
    }`}">Trang trước</a>
      </li>
...
async function renderHotelsByPage(selector, page) {
      ...
      50
              ...
              <div class="d-flex flex-column justify-content-center align-items-center">
                <div>
                  ...
                  <a class="text-decoration-none" style="color: red; font-weight: bold; font-size: 1.5rem">${vndCurrency
      }</a>
                </div>
                <div>
  ...
  <nav aria-label="Pagination">
    <ul class="pagination">
      <li class="page-item ${page === 1 ? "disabled" : ""}">
        <a class="page-link" href="${`hotels.html?page=${page - 1
    }`}">Trang trước</a>
      </li>
      <li class="page-item active" aria-current="page">
        <a class="page-link" href="#">${page}</a>
      ...
      <div class="offcanvas-body">
        ...
        <div class="row">
          <div class="d-flex justify-content-center col-12">
            ...
            <img src="assets/images/QR_NVH.jpg" class="img-fluid w-lg-25 w-sm-50">
          </div>
          <div class="d-flex justify-content-center mt-3 col-12">
            <div class="d-flex flex-column fw-bold border rounded p-3" style="font-size: 1.5rem;">
              <span class="mb-2">TÊN TÀI KHOẢN: <span class="text-danger">NGUYEN VAN HOANG</span></span>
              <span class="mb-2">SỐ TÀI KHOẢN: <span class="text-danger">1762731356</span></span>
              ...
              <span class="mb-2">NGÂN HÀNG: Vietcombank</span>
            </div>
          </div>
        </div>
        <hr class="mt-3 mb-3">
